...
from napi_interface import constant_filters
from napi_types import set_component_dirs
from napi_methods import method_filters
...
def origin_trial_enabled_if(code,
    ...
    function = napi_utilities.origin_trial_function_call(
...
def runtime_enabled_if(code, name):
    ...
    function = napi_utilities.runtime_enabled_function(name)
    return generate_indented_conditional(code, function)
...
def initialize_jinja_env(cache_dir):
    ...
    jinja_env.filters.update({
        ...
        napi_utilities.runtime_enabled_function,
        'secure_context':
        secure_context_if
    })
